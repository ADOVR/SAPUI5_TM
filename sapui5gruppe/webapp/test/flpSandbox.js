		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping Card",
									"targetURL": "#sapui5gruppe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5gruppe-display": {
								"semanticObject": "sapui5gruppe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5gruppe",
									"url": sap.ui.require.toUrl("sapui5gruppe")
								}
							}
						}
					}
