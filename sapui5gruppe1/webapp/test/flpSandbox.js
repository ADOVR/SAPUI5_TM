		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping Card",
									"targetURL": "#sapui5gruppe1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5gruppe1-display": {
								"semanticObject": "sapui5gruppe1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5gruppe1",
									"url": sap.ui.require.toUrl("sapui5gruppe1")
								}
							}
						}
					}
