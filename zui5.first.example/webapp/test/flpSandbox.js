		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DiesistderTitel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DiesistderTitel-display": {
								"semanticObject": "DiesistderTitel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zui5.first.example",
									"url": sap.ui.require.toUrl("zui5/first/example")
								}
							}
						}
					}
